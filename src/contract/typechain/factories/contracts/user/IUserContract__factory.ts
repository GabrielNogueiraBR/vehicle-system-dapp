...
} from "../../../contracts/user/IUserContract";
...
export class IUserContract__factory {
  ...
  static createInterface(): IUserContractInterface {
    return new utils.Interface(_abi) as IUserContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IUserContract {
    return new Contract(address, _abi, signerOrProvider) as IUserContract;
  }
}
