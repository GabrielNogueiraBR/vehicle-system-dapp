...
import type {
  IInsurerContract,
  IInsurerContractInterface,
} from "../../../contracts/insurer/IInsurerContract";
...
export class IInsurerContract__factory {
  static readonly abi = _abi;
  static createInterface(): IInsurerContractInterface {
    return new utils.Interface(_abi) as IInsurerContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IInsurerContract {
    return new Contract(address, _abi, signerOrProvider) as IInsurerContract;
  }
}
